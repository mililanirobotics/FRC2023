...
public class Limelight {
    ...
    */
    public double estimateHorizontalDistance(){
        ...
        double horizontalDistance = (LimeLightConstants.kTargetHeight - LimeLightConstants.kLensHeight) / Math.tan(LimeLightConstants.kMountAngle + veritcalTargetAngle);
    ...
    // public double estimateSideDistance(double verticalDistance){
    //     double horizontalTargetAngle = getHorizontalDegToTarget();
        
    //     double sideDistance = verticalDistance * Math.tan(horizontalTargetAngle);
